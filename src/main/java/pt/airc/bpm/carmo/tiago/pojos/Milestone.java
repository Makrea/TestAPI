 ...
 *
 */
@JsonPropertyOrder({ "id", "executionDate", "eventInstanceId", "eventInstanceName", "eventInstanceId_string" })
public class Milestone {
	 ...
	 *
	 */
	@JsonProperty("eventInstnaceName")
	private String eventInstanceName;
	/**
	 *
	 */
	@JsonProperty("eventInstanceId_string")
	...
	/**
	 *
	 * @return the event instance id in string
	 */
